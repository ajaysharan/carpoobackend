...
module.exports = (req, res, next) => {
    ...
    res.successInsert = function (data = [], message = null) {
    ...
    res.successUpdate = function (data = [], message = null) {
    ...
    // Responce :: Success Delete
    res.successDelete = function (data = [], message = null) {
        return this.status(200).json({
            status: true,
